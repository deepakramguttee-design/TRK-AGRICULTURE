  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        <div className={Icon ? '[&>input]:pl-9 [&>input]:pr-3' : ''}>{children}</div>
      </div>
...
export default function Login() {
  ...
  function validateReg() {
    ...
    if (!regForm.phone.trim() || !isValidMauritiusPhone(regForm.phone)) e.phone = 'Numéro mauricien invalide (8 chiffres)'
              ...
              <form onSubmit={handleRegister} className="flex flex-col gap-4">
                <Field label="Nom complet *" icon={User} error={regErrors.full_name}>
                  <Input
                    ...
                    autoComplete="name"
                    className={`pl-9 ${regErrors.full_name ? 'border-destructive' : ''}`}
                  />
                </Field>
                <Field label="Téléphone *" icon={Phone} error={regErrors.phone}>
                  <Input
                    ...
                    autoComplete="tel"
                    className={`pl-9 ${regErrors.phone ? 'border-destructive' : ''}`}
                  />
                </Field>
                <Field label="Email *" icon={Mail} error={regErrors.email}>
                  <Input
                    ...
                    autoComplete="email"
                    className={`pl-9 ${regErrors.email ? 'border-destructive' : ''}`}
                  />
                </Field>
                ...
                <p className="text-xs text-muted-foreground -mt-1">* Champs obligatoires</p>
